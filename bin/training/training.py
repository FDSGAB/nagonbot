...
kokoro = json.loads(open("./bin/kokoro/kokoro.json", encoding="utf8").read()) #Recebe o arquivo em JSON como, essencialmente, um dicionário em Python
...
pickle.dump(words, open('./bin/model/words.pkl', 'wb'))
pickle.dump(classes, open('./bin/model/classes.pkl', 'wb'))
...
model.save('./bin/model/nagonmodel.h5', hist)
print("出来ました！")