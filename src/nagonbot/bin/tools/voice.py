...
class Voice():
    ...
    def say(self, message):
        ...
        my_aud.save('./src/nagonbot/bin/temp/demo.mp3') #save the file with .mp3 extension
        playsound(sound = './src/nagonbot/bin/temp/demo.mp3', block = True) #to play it
        os.remove('./src/nagonbot/bin/temp/demo.mp3')
