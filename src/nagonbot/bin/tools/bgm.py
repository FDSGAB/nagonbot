...
class BGM():
    ...
    sound_directory = "./src/nagonbot/bin/data/sound/"
    bgm_list = []
    current_song = "./src/nagonbot/bin/data/sound/monstruo.wav"
    bgm_switch = False

    def __init__(self):
        self.bgm_list = os.listdir('./src/nagonbot/bin/data/sound')
...
if __name__ == "__main__":
    ...
    while True:
        ...
        if switch == "y":
            ...
            bgm_switch = False
     """
    print(os.listdir('./src/nagonbot/bin/data/sound'))
